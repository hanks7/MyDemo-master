...
public class TwentySeven2Activity extends Base2Activity {
    private static final String TAG = "TwentySeven2Activity";
    ...
    public static void startActivity(Context context) {
        ...
        intent.setClass(context, TwentySeven2Activity.class);
