...
public class TwentyTwo2Activity extends Base2Activity {
    private static final String TAG = "TwentyTwo2Activity";
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isAllGranted) {
                    ...
                    ActivityCompat.requestPermissions(TwentyTwo2Activity.this, new String[]{
                                    Manifest.permission.INTERNET
                            },
                            0);
                }
...
//                    socket1.close();
    ...
    public static void startActivity(Context context) {
        ...
        intent.setClass(context, TwentyTwo2Activity.class);
