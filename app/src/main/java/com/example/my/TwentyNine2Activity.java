 ...
 * on 2019/4/15 14:34
 */
public class TwentyNine2Activity extends Base2Activity {
    private static final String TAG = "TwentyNine2Activity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_toMain).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Thirty2Activity.startActivity(TwentyNine2Activity.this);
            }
        });
    ...
    public static void startActivity(Context context) {
        Intent intent = new Intent();
        intent.setClass(context, TwentyNine2Activity.class);
