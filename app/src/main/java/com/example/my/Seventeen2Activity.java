...
public class Seventeen2Activity extends Base2Activity {
    private static final String TAG = "Seventeen2Activity";
...
//        }
    ...
    public static void startActivity(Context context) {
        ...
        intent.setClass(context, Seventeen2Activity.class);
