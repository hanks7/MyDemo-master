...
public class Eight2Activity extends Base2Activity {
...
//        tabWidget.setDividerDrawable(null);//设置tabWeight没有竖线分割
        ...
        //初始化activity管理者
        LocalActivityManager manager = new LocalActivityManager(Eight2Activity.this, false);
        //通过管理者保存当前页面状态
    ...
    public void init_intent() {
        intents[0] = new Intent(this, Second2Activity.class);
        intents[1] = new Intent(this, Third2Activity.class);
        intents[2] = new Intent(this, Four2Activity.class);
        intents[3] = new Intent(this, Five2Activity.class);
    }

    public static void startActivity(Context context) {
        Intent intent = new Intent();
        intent.setClass(context, Eight2Activity.class);
