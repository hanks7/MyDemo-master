...
public class TwentyTwo12Activity extends Base2Activity {
    private static final String TAG = "TwentyTwo12Activity";
    //打开扫描界面请求码
    ...
    private void initData() {
        ...
        myHandler = new MyHandler(TwentyTwo12Activity.this);
        ...
        btn_unbind.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!TextUtils.isEmpty(ibcon_code.getText().toString())) {
                    TwentyTwo2Activity.startActivity(TwentyTwo12Activity.this, ibcon_code.getText().toString().trim());
                } else {
    ...
    private void setData() {
        if (isAllGranted) {
            ...
            ActivityCompat.requestPermissions(TwentyTwo12Activity.this, new String[]{
                            Manifest.permission.BLUETOOTH
                    },
                    0);
        }
...
//        }
    ...
    static class MyHandler extends Handler {
        WeakReference<TwentyTwo12Activity> mWeakReference;

        public MyHandler(TwentyTwo12Activity activity) {
            mWeakReference = new WeakReference<>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            TwentyTwo12Activity activity = mWeakReference.get();
            switch (msg.what) {
                case FOUND_DEVICE:
    ...
    public static void startActivity(Context context) {
        ...
        intent.setClass(context, TwentyTwo12Activity.class);
