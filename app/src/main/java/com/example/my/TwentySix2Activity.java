...
public class TwentySix2Activity extends Base2Activity {
    private static final String TAG = "TwentySix2Activity";
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (mCurrentTime - mLastTime < 800) {//长按不起作用
                        ...
                        if (Math.abs(mStartX - mLastX) < 10.0 && Math.abs(mStartY - mLastY) < 10.0) {//判断是否属于点击
                            Toast.makeText(TwentySix2Activity.this, "可以执行点击任务", Toast.LENGTH_SHORT).show();
                        }
                    }
                    break;
                default:
    ...
    public static void startActivity(Context context) {
        ...
        intent.setClass(context, TwentySix2Activity.class);
