...
public class AddOrder2Activity extends Base2Activity {
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                ...
                case R.id.ll_fromWhere:
                    ...
                    fromWhereIntent.setClass(AddOrder2Activity.this, AddAddress2Activity.class);
                ...
                case R.id.ll_toWhere:
                    ...
                    toWhereIntent.setClass(AddOrder2Activity.this, AddAddress2Activity.class);
                    startActivityForResult(toWhereIntent, REQUEST_CODE);
                    break;
                case R.id.btn_submit:
                    if (addBook()) {
                        Toast.makeText(AddOrder2Activity.this, "添加成功", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(AddOrder2Activity.this, "添加失败", Toast.LENGTH_SHORT).show();
                    }
                    break;
                case R.id.tv_fromWhereAddressBook:
                    ...
                    fromWhereAddressBookIntent.setClass(AddOrder2Activity.this, AddressBooks2Activity.class);
                ...
                case R.id.tv_toWhereAddressBook:
                    ...
                    toWhereAddressBookIntent.setClass(AddOrder2Activity.this, AddressBooks2Activity.class);
                    startActivityForResult(toWhereAddressBookIntent, REQUEST_CODE);
                    break;
                case R.id.tv_serviceText:
                    AppText2Activity.startActivity(AddOrder2Activity.this);
                    break;
                default:
                    break;
            }
...
//        picker.setLabel("分");
    ...
    public static void startActivity(Context context) {
        ...
        intent.setClass(context, AddOrder2Activity.class);
