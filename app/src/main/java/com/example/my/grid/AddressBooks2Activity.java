...
public class AddressBooks2Activity extends Base2Activity {
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                case R.id.btn_addAddress:
                    ...
                    intent.setClass(AddressBooks2Activity.this, AddAddress2Activity.class);
    ...
    public static void startActivity(Context context) {
        Intent intent = new Intent();
        intent.setClass(context, AddressBooks2Activity.class);
