...
public class AddAddress2Activity extends Base2Activity {
    ...
    private View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (TextUtils.isEmpty(name) || TextUtils.isEmpty(tel)
                ...
                Toast.makeText(AddAddress2Activity.this, "将内容填写完整", Toast.LENGTH_SHORT).show();
            } else {
                ...
                Toast.makeText(AddAddress2Activity.this, "保存成功", Toast.LENGTH_SHORT).show();
                finish();
            }
        }
    };
    ...
    public static void startActivity(Context context) {
        Intent intent = new Intent();
        intent.setClass(context, AddAddress2Activity.class);
