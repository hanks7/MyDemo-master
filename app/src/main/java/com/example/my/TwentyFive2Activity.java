...
public class TwentyFive2Activity extends Base2Activity implements ITXLivePushListener {
    private static final String TAG = "TwentyFour2Activity";
...
//        mLivePushConfig.setPauseFlag(TXLiveConstants.PAUSE_FLAG_PAUSE_VIDEO | TXLiveConstants.PAUSE_FLAG_PAUSE_AUDIO);
    ...
    public static void startActivity(Context context) {
        ...
        intent.setClass(context, TwentyFive2Activity.class);
