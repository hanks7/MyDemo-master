...
public class Third2Activity extends Base2Activity {
        ...
        btn_click.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (bluetoothAdapter.isEnabled()) {
                    Toast.makeText(Third2Activity.this, "已连接蓝牙", Toast.LENGTH_SHORT).show();
                } else {
//                    boolean rd = bluetoothAdapter.enable();
                    Intent intent = new Intent(BluetoothAdapter.ACTION_REQUEST_ENABLE);
                    startActivityForResult(intent, 0);
//                    Toast.makeText(Third2Activity.this, "连接蓝牙：" + rd, Toast.LENGTH_SHORT).show();
                }
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                OtherUtil.showToast(Third2Activity.this, "showToast");
            }
        });
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(Third2Activity.this
    ...
    public static void startActivity(Context context) {
        ...
        intent.setClass(context, Third2Activity.class);
